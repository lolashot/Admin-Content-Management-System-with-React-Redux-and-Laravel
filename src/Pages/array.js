...
function Events() {
    ...
    const newobject = {
        ...
        details: "fsghs whhwjw nhujw hujjwjw whhwhhw"
    ...
    const retrieveEvents = () => { 
        EventsDataService.getAll()
            .then(response => {
                response.data.data.push(newobject);
                response.data.data.unshift(newobject);
                response.data.data.pop();
                response.data.data.shift();
                response.data.data.copyWithin(0,11);
                response.data.data.copyWithin(0,11,14);
                response.data.data.fill(newobject,0,12);
                response.data.data.reverse();
                response.data.data.splice(1, 0, newobject);
